...
test("tokenizer", function ()
  ...
  test("validity errors", function ()
    ...
    assert(not pcall(function () tokenizer.create({ ngram_min = 3, ngram_max = 5, types = true, shapes = true, n_types = 2 }) end))
    assert(not pcall(function () tokenizer.create({ ngram_min = 3, ngram_max = 5, types = true }) end))
  end)
