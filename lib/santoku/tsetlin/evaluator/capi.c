...
static inline tk_ivec_t *tm_optimize_bits_generic (
  ...
  tk_ivec_t *active = tk_ivec_create(L, 0, 0, 0);
  tk_ivec_t *removed = tk_ivec_create(L, 0, 0, 0);
...
static inline tk_ivec_t *tm_optimize_bits_prefix (
  ...
  tk_ivec_t *removed = tk_ivec_create(L, n_dims, 0, 0);
  bool converged = false;
